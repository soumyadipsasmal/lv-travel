    ...
    <div class="wrapper pa-0">
        <header class="sp-header">
            ...
            <div class="form-group mb-0 pull-right">
                ...
                <a class="inline-block btn btn-info btn-rounded btn-outline" href="{{ url('login') }}">Sign
                    In</a>
            </div>
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label mb-10"
                                                    for="exampleInputName_1">Username</label>
                                                <input type="text" class="form-control"
                                                    id="exampleInputName_1" placeholder="Username" name="name"
                                                    value="{{ old('name') }}">
                                                    @error('name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control"
                                                    name="password" id="exampleInputpwd_2" placeholder="Enter pwd">
                                                    @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control"
                                                    id="exampleInputpwd_3" placeholder="Enter pwd"
