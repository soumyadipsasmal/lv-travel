...
@section('main_content')
    ...
    <section class="w3l-main-slider" id="home">
        <div class="banner-content">
            <div id="demo-1"
                data-zs-src='["front-assets/images/banner1.jpg", "front-assets/images/banner2.jpg"
                ,"front-assets/images/banner3.jpg", "front-assets/images/banner4.jpg" ]'
                    ...
                    <div class="container">
                        <div class="banner-infhny">
                            ...
                            <div class="flex-wrap search-wthree-field mt-md-5 mt-4">
                                <form action="{{ route('toursearch') }}" method="get" class="booking-form">
                                    <div class="row book-form">
                                        <div class="form-input col-md-4 mt-md-0 mt-3">
                                            <select name="cat" class="selectpicker">
                                                <option value="">Selcet Tour Categories</option>
                                                @if (isset($catdata))
                    ...
                    @foreach ($catdata as $cat)
                        <div class="col-lg-6 subject-card mt-lg-0 mt-4 mb-4">
                            <div class="subject-card-header p-4">
                                <a href="{{ route('catdetails', $cat->catslug) }}" class="card_title p-lg-4d-block">
                                    <div class="row align-items-center">
                                        <div class="col-sm-5 subject-img">
                                            @if ($cat->catimage)
                                                <img src="{{ asset('storage/' . $cat->catimage) }}" class="img-fluid"
                                                    alt="">
                                            @else
                                ...
                                <div class="mt-1 d-flex justify-content-end align-center">
                                    <a href="{{ route('catdetails', $cat->catslug) }}"
                                        class="btn btn-success text-center">View</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="col-lg-6 subject-card mt-lg-0 mt-4 mb-4">
                            <div class="subject-card-header p-4">
                                <a href="{{ route('tourdetails', $tour->id) }}" class="card_title p-lg-4d-block">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-7 subject-content mt-sm-0 mt-4">
                                            ...
                                            <p class="py-2">Tour Place: {{ $tour->tour_place }}</p>
                                            <p>{{ $tour->tour_duration }} Days</p>
                                            <div class="dst-btm">
                                                <h6 class=""> Start From -
                                                    {{ date('y-m-d', strtotime($tour->tour_start)) }} </h6>
                                ...
                                <div class="mt-3 d-flex justify-content-between align-center">
                                    <a href="{{ route('tourdetails', $tour->id) }}"
                                        class="btn btn-success text-center">View</a>
                                    <a href="{{ route('bookings', $tour->id) }}" class="btn btn-primary text-center">Book
                                        Now</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="maghny-gd-1 col-lg-6">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius  m-0">
                            <img class="img-fluid" src="front-assets/images/g10.jpg" alt="" />
                            <figcaption>
                                <div>
                ...
                <div class="maghny-gd-1 col-lg-6 mt-lg-0 mt-4">
                    <div class="row">
                        <div class="maghny-gd-1 col-6">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="front-assets/images/g9.jpg" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1220$ </p>
                        ...
                        <div class="maghny-gd-1 col-6">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="front-assets/images/g8.jpg" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1620$ </p>
                        ...
                        <div class="maghny-gd-1 col-6 mt-4">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="front-assets/images/g7.jpg" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1820$ </p>
                        ...
                        <div class="maghny-gd-1 col-6 mt-4">
                            <div class="maghny-grid">
                                <figure class="effect-lily border-radius">
                                    <img class="img-fluid" src="front-assets/images/g6.jpg" alt="" />
                                    <figcaption>
                                        <div>
                                            <h4>3Days, 4 Nights</h4>
                                            <p>From 1520$ </p>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="front-assets/images/c2.jpg" class="img-fluid"
                                                alt="client-img">
                                        </div>
                                        <div class="peopl align-self">
                                            <h3>Shveta</h3>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="front-assets/images/c3.jpg" class="img-fluid"
                                                alt="client-img">
                                        </div>
                                        <div class="peopl align-self">
                                            <h3>Roy Linderson</h3>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="front-assets/images/c4.jpg" class="img-fluid"
                                                alt="client-img">
                                        </div>
                                        <div class="peopl align-self">
                                            <h3>Mike Thyson</h3>
